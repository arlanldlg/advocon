	...
	<center>
			...
			<div class="form_container">
			 <form action="registerprocess.php" method="post">
				...
				First Name: <input type="text" name="Fname" required="required" class="one-col-input"/><br>
				Last Name: <input type="text" name="Lname" required="required" class="one-col-input"/><br>
...
<select name="year" id = "year">
	...
	<option value="1947">1947</option>
				...
				<a href=regfound.php>Register a Foundation</a><br>
